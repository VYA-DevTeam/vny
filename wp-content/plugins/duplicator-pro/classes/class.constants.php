...
class DUP_PRO_Constants
{
    ...
    public static $IMPORT_SUBMENU_SLUG;
    ...
    public static $IMPORT_INSTALLER_PAGE;
    ...
    public static function init()
    {
        ...
        self::$IMPORT_SUBMENU_SLUG    = self::PLUGIN_SLUG.'-import';
        ...
        self::$IMPORT_INSTALLER_PAGE  = self::PLUGIN_SLUG.'-import-installer';
