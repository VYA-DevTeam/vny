...
class DUP_PRO_MU
{
    ...
    public static function getSubsites($filteredSites = array(), $filteredTables = array(), $filteredPaths = array())
    {
        ...
        foreach ($sites as $site) {
            ...
            $site_info->filtered_paths  = array_values(array_filter($filteredPaths, function ($path) use ($subsiteID) {
                return DupProSnapLibIOU::getRelativePath(WP_CONTENT_DIR.'/uploads/sites/'.$subsiteID, $path) !== false;
            }));
