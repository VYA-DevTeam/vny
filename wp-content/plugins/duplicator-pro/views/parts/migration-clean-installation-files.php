...
<div class="dpro-diagnostic-action-installer">
    <p>
        <b><?php echo DUP_PRO_U::__('Installer file cleanup ran!'); ?></b>
    </p>
    <?php
    ...
    <div style="font-style: italic; max-width:900px; padding:10px 0 25px 0;">
        <p>
            <b><i class="fa fa-shield-alt"></i> <?php DUP_PRO_U::esc_html_e('Security Notes'); ?>:</b> <?php
        ...
        <p>
            <b><i class="fa fa-thumbs-up"></i> <?php DUP_PRO_U::esc_html_e('Help Support Duplicator'); ?>:</b> <?php
