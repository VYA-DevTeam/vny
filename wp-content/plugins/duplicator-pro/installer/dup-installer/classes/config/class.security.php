...
class DUPX_Security
{
    ...
    private function __construct()
    {
        ...
        $this->bootLogFile          = DupProSnapLibIOU::safePath(DUPX_CSRF::getVal('bootLogFile'));
        $this->bootFilePath         = DupProSnapLibIOU::safePath(DUPX_CSRF::getVal('installerOrigPath'));
        $this->archivePath          = DupProSnapLibIOU::safePath(DUPX_CSRF::getVal('archive'));
