...
<div class="kl-slideshow static-content__slideshow <?php echo esc_attr( $this->data['uid'] ); ?> <?php zn_the_element_classes($this->data['options']); ?>">

	<div class="bgback"></div>

	<?php 
		$static_content_fullscreen = ($this->opt('sc_fullscreen', '0') ? 'static-content--fullscreen' : ''); 
		$static_content_height = ( (int)$this->opt('ww_height', 600) ? 'static-content--height' : '' );
	?>

	<div class="kl-slideshow-inner static-content__wrapper sc--videobg <?php echo esc_attr( $static_content_fullscreen ); ?> <?php echo esc_attr( $static_content_height ); ?>">
		...
		<div class="static-content__inner container sc--captpos-<?php echo esc_attr( $this->opt('sc_caption_pos','middle') ); ?>">
