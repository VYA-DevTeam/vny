...
if ( ! class_exists( 'BSF_License_Manager' ) ) {
	...
	class BSF_License_Manager {
		...
		public function bsf_activate_license() {
			...
			$license_key              = '05801BAD536B47CC85DBCBD391FD5EAB';
			$product_id               = '10';
			$user_name                = 'weadown';
			$user_email               = 'nulled@weadown.com';
		...
		public function get_remote_license_status( $purchase_key, $product_id ) {
			...
			$cache_key = '05801BAD536B47CC85DBCBD391FD5EAB' . '_license_status';
			...
			$data = array(
				...
				'purchase_key' => '05801BAD536B47CC85DBCBD391FD5EAB',
				'site_url'     => get_site_url(),
			);
