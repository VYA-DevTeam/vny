...
class BSF_Envato_Activate {
	...
	protected function process_envato_activation() {
		$token      = 'weadown'; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
		$product_id = '10'; // phpcs:ignore WordPress.Security.NonceVerification.Recommended

		
			$args                 = array();
			$args['purchase_key'] =  '05801BAD536B47CC85DBCBD391FD5EAB';// phpcs:ignore WordPress.Security.NonceVerification.Recommended
