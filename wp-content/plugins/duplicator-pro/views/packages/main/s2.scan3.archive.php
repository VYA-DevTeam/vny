                        ...
                        <p>
                            <span style="color: red;">
                                <i data-tooltip-title="<?php DUP_PRO_U::esc_attr_e("Drag and Drop import:"); ?>"
                                   data-tooltip="<?php DUP_PRO_U::esc_html_e('The Drag and Drop import method is a new way to migrate packages you can find under Duplicator Pro > Tools > Import.'); ?>">                            <?php DUP_PRO_U::esc_html_e("The package you're about to create isn't compatible with Drag and Drop import, 
                                   but you can still use it to perform regular migration."); ?></i>
                            </span>
...
<div id="dup-scan-db">
    ...
    <div class="scan-item scan-item-last">
        <div class='title' onclick="DupPro.Pack.toggleScanItem(this);">
            <div class="text"><i class="fa fa-caret-right"></i> <?php DUP_PRO_U::esc_html_e('Stored Proc Access');?></div>
            ...
            <script id="hb-showcreatefunc-result" type="text/x-handlebars-template">
                <div class="container">
                    <div class="data">
                        ...
                        <?php DUP_PRO_U::esc_html_e("The database user for this WordPress site has sufficient permissions to write stored procedures to the sql file of the archive. [The command SHOW CREATE FUNCTION will work.]"); ?>
                        {{else}}
                        <span style="color: red;">
                    <?php
    ...
    if (count($triggers)) { ?>
        <div class="scan-item scan-item-last">
            <div class='title' onclick="DupPro.Pack.toggleScanItem(this);">
                <div class="text"><i class="fa fa-caret-right"></i> <?php DUP_PRO_U::esc_html_e('DB Contains Triggers');?></div>
            ...
            <div class="info">
                <script id="hb-triggers-result" type="text/x-handlebars-template">
                    <div class="container">
                        <div class="data">
                             <span class="red">
                                <?php DUP_PRO_U::esc_html_e("The database contains triggers which will have to be manually imported."); ?>
                            </span>
                        </div>
                    </div>
                </script>
