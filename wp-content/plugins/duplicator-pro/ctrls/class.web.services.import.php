...
class DUP_PRO_Web_Services_import extends DUP_PRO_Web_Services
{
    ...
    {
        self::ajax_json_wrapper(array(__CLASS__, 'importUploadCallback'), 'duplicator_pro_import_upload', $_POST['nonce'], 'export');
    }
    ...
    public static function deletePackageCallback()
    {
        ...
        $normalized_file_path  = DupProSnapLibIOU::safePath($inputData['path'], true);
    ...
    {
        self::ajax_json_wrapper(array(__CLASS__, 'deletePackageCallback'), 'duplicator_pro_import_package_delete', $_POST['nonce'], 'export');
    }
    ...
    {
        self::ajax_json_wrapper(array(__CLASS__, 'setViewModeCallback'), 'duplicator_pro_import_set_view_mode', $_POST['nonce'], 'export');
    }
}