...
class DUPX_InstallerState
{
    ...
    {
        $template = DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_TEMPLATE);
    ...
    public static function getMigrationData()
    {
        ...
        return array(
            ...
            'safeMode'            => $paramsManager->getValue(DUPX_Paramas_Manager::PARAM_SAFE_MODE),
            'cleanInstallerFiles' => $paramsManager->getValue(DUPX_Paramas_Manager::PARAM_AUTO_CLEAN_INSTALLER_FILES),
            'restoreBackupMode'   => $paramsManager->getValue(DUPX_Paramas_Manager::PARAM_RESTORE_BACKUP_MODE)
        );
    }
    ...
    {
        return DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_SITE_URL).'/wp-login.php';
    }
}