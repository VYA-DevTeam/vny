...
$cleanFileAction = (DupProSnapLibUtil::filterInputRequest('action', FILTER_DEFAULT) === 'installer');
?>
<div class="dup-notice-success notice notice-success duplicator-pro-admin-notice dup-migration-pass-wrapper" >
    ...
    <p>
        <?php printf(DUP_PRO_U::__('The following installation files are saved in the folder <b>%s</b>'), DUPLICATOR_PRO_SSDIR_PATH_INSTALLER); ?>
    </p>
