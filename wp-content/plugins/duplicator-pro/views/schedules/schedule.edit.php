...
$min_frequency = 0;
$max_frequency = (($license_type === DUP_PRO_License_Type::Freelancer) || ($license_type === DUP_PRO_License_Type::BusinessGold)) ? DUP_PRO_Schedule_Repeat_Types::Hourly : DUP_PRO_Schedule_Repeat_Types::Monthly;
