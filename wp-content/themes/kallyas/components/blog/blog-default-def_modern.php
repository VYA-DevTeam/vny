...
<div class=" kl-blog-item-container <?php echo esc_attr( $featPostClass );?> <?php echo implode ( ' ' , get_post_class('blog-post' ) ); ?>" <?php echo WpkPageHelper::zn_schema_markup('blogpost'); ?>>
    <?php
