...
class DUPX_Validation_test_multisite_subfolder extends DUPX_Validation_abstract_item
{
    ...
    protected function runTest()
    {
        ...
        if (DUPX_MU::newSiteAction() === DUPX_MultisiteMode::Subdomain && $this->newUrlIsInSubFolder()) {
    ...
    {
        return parse_url(DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_URL_NEW),PHP_URL_PATH) !== null;
    }
