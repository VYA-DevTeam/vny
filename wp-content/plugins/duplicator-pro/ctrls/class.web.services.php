    ...
    public static function admin_notice_to_dismiss_callback()
    {
        ...
        switch ($noticeToDismiss) {
            ...
            case DUP_PRO_UI_Notice::OPTION_KEY_MIGRATION_SUCCESS_NOTICE:
                ...
                break;
            case DUP_PRO_UI_Notice::OPTION_KEY_EXPIRED_LICENCE_NOTICE_DISMISS_TIME:
                $ret = update_option(DUP_PRO_UI_Notice::OPTION_KEY_EXPIRED_LICENCE_NOTICE_DISMISS_TIME, time());
                break;
            default:
