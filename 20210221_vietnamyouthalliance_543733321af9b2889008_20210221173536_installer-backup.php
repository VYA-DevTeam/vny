...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210221_vietnamyouthalliance_543733321af9b2889008_20210221173536_archive.zip';
    const ARCHIVE_SIZE       = '494754276';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '5437333-21173536';
    const SECONDARY_PACKAGE_HASH = '2c3bae4-21173536';
    const VERSION            = '4.0.2';
