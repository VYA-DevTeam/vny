...
$sqlDownloadInfoJson       = DupProSnapJsonU::json_encode_esc_attr($sqlDownloadInfo);
$archiveDownloadInfoJson   = DupProSnapJsonU::json_encode_esc_attr($archiveDownloadInfo);
$logDownloadInfoJson       = DupProSnapJsonU::json_encode_esc_attr($logDownloadInfo);
$scanDownloadInfoJson      = DupProSnapJsonU::json_encode_esc_attr($scanDownloadInfo);
$installerDownloadInfoJson = DupProSnapJsonU::json_encode_esc_attr($installerDownloadInfo);
$showLinksDialogJson       = DupProSnapJsonU::json_encode_esc_attr(array(
