...
if ( ! empty($footer_smart_area)) {
	if (isset($footer_smart_area['footer_location']) && 'replace' == $footer_smart_area['footer_location']) {
...
$admin_options[] = array(
	...
	'description'       => __( 'Here you can select how your footer row 1 widgets will be displayed. You can select to use up to 4 widgets positions in various sizes.', 'zn_framework' ),
	'id'                => 'footer_row1_widget_positions',
	'std'               => '{"3":[["4","4","4"]]}',
	'type'              => 'widget_positions',
	'number_of_columns' => '4',
	'dependency'        => array(
		'element' => 'footer_row1_show',
		'value'   => array( 'yes' ),
	),
...
$admin_options[] = array(
	...
	'description'       => __( 'Here you can select how your footer row 2 widgets will be displayed. You can select to use up to 4 widgets positions in various sizes.', 'zn_framework' ),
	'id'                => 'footer_row2_widget_positions',
	'std'               => '{"2":[["6","6"]]}',
	'type'              => 'widget_positions',
	'number_of_columns' => '4',
	'dependency'        => array(
		'element' => 'footer_row2_show',
		'value'   => array( 'yes' ),
	),
	'columns_positions' => array(
		'1' => array(
