...
<?php $packageAlreadyExists->showMessage(); ?>
            ...
            onFileStart: function (e, file)
            {
                ...
                let loader = DupPro.ImportManager.packageRowUploading.find('.funcs .loader').removeClass('no-display');
            ...
            onFileProgress: function (e, file, percent, eventObj)
            {
                ...
                let loader = DupPro.ImportManager.packageRowUploading.find('.funcs .loader');
            ...
            onFileComplete: function (e, file, response)
            {
                ...
                DupPro.ImportManager.packageRowUploading.find('.funcs .loader').addClass('no-display');
